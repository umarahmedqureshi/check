...
function getShopifyOrderTransactions($shopify_store, $access_token, $api_version, $order_id) {
    $url = "https://$shopify_store/admin/api/$api_version/orders/$order_id/transactions.json";
...
try {
    ...
    $result = getShopifyOrderTransactions($shopify_store, $access_token, $api_version, $order_id);
